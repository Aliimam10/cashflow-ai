...
Commit 25 adds a local, read-only review service. It identifies transactions that
may deserve attention; it does not diagnose fraud, block a payment, change a category,
or edit imported evidence. The only user-facing labels are `Unusual`,
